...
class GalaxyInfo(object):
    ...
    def __init__(self, galaxy_url):
        ...
        :class:`agentdog.edam_to_galaxy.GalaxyInfo` object is initialized with several
...
class EdamToGalaxy(object):
    ...
    def generate_mapping(self):
        ...
        def find_datatype(edam, edam_hierarchy, galaxy_mapping):
            ...
            :type edam: STRING
            :param edam_hierarchy: edam_hierarchy from :class:`agentdog.edam_to_galaxy.EdamInfo`
            :type edam_hierarchy: DICT
            :param galaxy_mapping: mapping from :class:`agentdog.edam_to_galaxy.GalaxyInfo`
