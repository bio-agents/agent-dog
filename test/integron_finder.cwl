...
cwlVersion: v1.0
doc: |+
  A agent to detect Integron in DNA sequences

  External links:
  Agent homepage: https://github.com/gem-pasteur/Integron_Finder
  bio.agents entry: integron_finder
...
inputs:
  INPUT1:
    ...
    type: File
label: A agent to detect Integron in DNA sequences.
outputs:
  OUTPUT1:
  ...
  OUTPUT2:
    ...
    type: File
s:about: A agent to detect Integron in DNA sequences
